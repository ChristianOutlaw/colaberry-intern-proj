...
### 6. Interaction-Level Enforcement (Non-Negotiable)

Before creating, modifying, deleting, or generating ANY file or code, Claude must:

1. Explain the intended action clearly.
2. State the exact filename(s) involved.
3. State the exact directory path.
4. Confirm whether the file already exists or must be created.
5. Ask for explicit approval before proceeding.
6. Wait for confirmation before generating code or writing files.
...
- Minor edits
- Refactors
- Any execution-layer artifacts

No file creation or modification may occur without explicit user approval.
